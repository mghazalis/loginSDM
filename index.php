...
/* Define username and associated password array */$logins = array('IT' => 'IT12345','SDM' => 'SDM12345');
...
header("location:http://bit.ly/INKAPeople");
exit;
} else {
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" action="" method="post" name="Login_Form">
					<span class="login100-form-title p-b-51">
						Dashboard SDM <br>PT INKA (Persero)
					</span>
